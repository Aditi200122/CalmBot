...
function startSession() {
    ...
    .then(data => {
        ...
        // Show animation only for breathing category
        // Show animation only for breathing category
...
//     .then(response => response.json())
//     .then(data => {
//         document.getElementById("responseBox").innerHTML += `<p><b>Session ended.</b> ${data.message}</p>`;
//     });
// }
// let breathText = document.getElementById("breathText");
// let states = ["Inhale", "Hold", "Exhale", "Hold"];
...
function endSession() {
    ...
    .then(data => {
        ...
        // Replace entire page content with final thank-you message
